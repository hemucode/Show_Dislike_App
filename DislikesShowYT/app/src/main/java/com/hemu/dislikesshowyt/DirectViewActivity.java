...
public class DirectViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_direct_view);
        ...
        if (Objects.equals(type, "link")){
            ...
            String image_url ="https://i.ytimg.com/vi/"+VideoId+"/hqdefault.jpg";
            Picasso.get().load(image_url).into(thumbnail);
            apiRequest(VideoId);
        ...
        web.setWebViewClient(new WebViewClient(){
            ...
            public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
                Toast.makeText(DirectViewActivity.this, "error", Toast.LENGTH_SHORT).show();
    ...
    private void dataLoadApi(String id) {
        ...
        ObjectDataService service = new ObjectDataService(DirectViewActivity.this);
            ...
            public void onResponse(JSONObject response) {
               // Log.d(TAG, "1onErrorResponses: " + response);
                try {
                    ...
                    des.setText(jsonObject2.getString("description"));
                    channel_name.setText(jsonObject2.getString("channelTitle"));

                    tags.setText("#TAGS "+jsonObject2.getString("tags"));
    ...
    public class WebAppInterface {
        ...
        public void showToast(String toast) {
            ...
            if (toast.equals("toast")){
                DirectViewActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
